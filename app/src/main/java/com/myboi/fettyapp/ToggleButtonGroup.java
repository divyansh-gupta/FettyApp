...
public class ToggleButtonGroup implements OnClickListener {
    ...
    private Stack<ToggleButton> clickHistory;
    ...
    public ToggleButtonGroup() {
        clickHistory = new Stack<ToggleButton>();
     ...
     */
    public ToggleButtonGroup add(ToggleButton... buttons) {
    ...
    public void onClick(View buttonClicked) {
        clickHistory.push((ToggleButton) buttonClicked);
    ...
    public void selectPreviouslyClicked() {
        if (clickHistory.isEmpty()) return;
        clickHistory.pop();
        if (clickHistory.isEmpty()) return;
        ToggleButton prev = clickHistory.pop();
        this.onClick(prev);
    }
